...
class MessageHandler:
    ...
    def handle_private_orders_message(self, order_data: Dict[str, Any]) -> None:
        """
        ...
        try:
            ...
            # Prepare trade data
            trade_data = self._prepare_trade_data(order_data)
    ...
    def _prepare_trade_data(self, order_data: Dict[str, Any]) -> Dict[str, Any]:
...
def _establish_connection(subaccount_name: str, credentials: Dict[str, str]) -> bool:
    ...
    try:
        ...
        def order_callback(message):
            message_handler.handle_private_orders_message(message)
